 ...
 * @author azank
 */
@WebServlet(name = "ServletBonusRemote", urlPatterns = {"/ServletBonusRemote"})
public class ServletBonusRemote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < l.size() + 1; i++) {
            ...
            try {
                ...
                session.BonusRemote ref = (session.BonusRemote) ctx.lookup("Bonus");
                map.put("amount",ref.doMultiplication(l.get(0)[i], l.get(1)[i]));
